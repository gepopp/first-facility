...
<p class="text-white text-lg mt-5">{{ $number }}</p>
    <div class="h-full overflow-hidden">
        <div class="w-0.5 mx-auto bg-white/75 h-full relative">
            <div x-cloak
                 x-show="onScreen"
                 ...
                 class="absolute top-0 left-0 w-1 bg-white h-48 -translate-x-px"></div>
        </div>
    </div>
</div>
